...
const starters={apprentice:['ranger','bow'],scholar:['battlemage','staff'],warden:['knight','sword'],herbalist:['trailkeeper','axe'],barbarian:['trailkeeper','axe'],mage:['battlemage','staff'],knight:['knight','sword'],rogue:['ranger','bow']};
