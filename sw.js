...
const CACHE='kkquest-v4.0.0'; // bump with APP_VERSION in index.html on every deploy
...
const PIXEL=['assets/pixel/male-battlemage.png', 'assets/pixel/male-trailkeeper.png', 'assets/pixel/bow.png', 'assets/pixel/female-battlemage.png', 'assets/pixel/hat.png', 'assets/pixel/shield.png', 'assets/pixel/dustpan.png', 'assets/pixel/paddle.png', 'assets/pixel/female-trailkeeper.png', 'assets/pixel/circlet.png', 'assets/pixel/dragon.png', 'assets/pixel/dragon-adult.png', 'assets/pixel/griffin.png', 'assets/pixel/griffin-adult.png', 'assets/pixel/male-ranger.png', 'assets/pixel/female-ranger.png', 'assets/pixel/male-knight.png', 'assets/pixel/female-knight.png', 'assets/pixel/lantern.png', 'assets/pixel/wolf.png', 'assets/pixel/wolf-adult.png', 'assets/pixel/sword.png', 'assets/pixel/hood.png', 'assets/pixel/cap.png', 'assets/pixel/axe.png', 'assets/pixel/helmet.png', 'assets/pixel/saber.png', 'assets/pixel/hammer.png', 'assets/pixel/fox.png', 'assets/pixel/fox-adult.png', 'assets/pixel/goggles.png', 'assets/pixel/lawson.png', 'assets/pixel/spear.png', 'assets/pixel/rake.png', 'assets/pixel/staff.png', 'assets/pixel/stage-bg.jpg'];
const ASSETS=[...PIXEL,'pixel-core.js','pixel-ui.js','pixel.css','./','index.html','three.min.js','manifest.webmanifest','map.jpg','bg-map2.jpg','theme.mp3',
